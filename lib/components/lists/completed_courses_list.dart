...
class CompletedCoursesList extends StatefulWidget {
  @override
  State<CompletedCoursesList> createState() => _CompletedCoursesList();
}

class _CompletedCoursesList extends State<CompletedCoursesList> {
      ...
      children: completedCourses.map((course) {
        ...
        return Container(width: 10.0, height: 10.0,
          ...
          decoration: BoxDecoration(
              ...
              color: currentPage == index ? Color(0xFF0971FE) : Color(
                  0xFFA6AEBD)
          ),
        );
      }).toList(),
