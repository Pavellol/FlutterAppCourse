...
import 'package:desingcode/components/certificate_viewer.dart';
import 'package:desingcode/components/lists/completed_courses_list.dart';
import 'package:desingcode/constants.dart';
import 'package:desingcode/model/course.dart';
                          ...
                          itemCount: badges.length,
                            itemBuilder:(context, index){
                              return Container(
                                ...
                                child: Image.asset('assert/badges/${badges[index]}'),
                              );
                            }
                        ),
                      ),
